...
with dag:
    ...
    load_airport_csv = GoogleCloudStorageToBigQueryOperator(
        ...
        destination_project_dataset_table='sandbox.airport_test_anirudh',
        source_format='CSV',
    ...
    airport_na_create = BigQueryOperator(
        ...
        `practice-271500.sandbox.airport_na_anirudh`(
            ident STRING,
            type STRING,
            name STRING,
            elevation_ft INT64,
    ...
    airport_na_insert = BigQueryOperator(
        ...
        sql='''
        #standardSQL
        DELETE FROM sandbox.airport_na_anirudh WHERE TRUE;
        INSERT INTO sandbox.airport_na_anirudh
        SELECT * FROM sandbox.airport_test_anirudh WHERE
            type != 'closed'
            AND continent = 'NA';
        ''',
        use_legacy_sql=False,
